...
var text_start;
var key_start;
var expertise_questionClock;
var question_text;
var expertise_answer;
var key_respexpert;
var instr_aospanClock;
var text_4;
var key_resp_5;
var warningeClock;
var text_6;
...
var text_que;
var key_respque;
var test_ratingClock;
var ret_question_text;
var ret_answer;
var key_resptestt;
var ebatspsClock;
var text_sps;
...
async function experimentInit() {
  ...
  text_4 = new visual.TextStim({
    ...
    font: 'Arial',
    units: 'height', 
    pos: [0, 0], draggable: false, height: 0.035,  wrapWidth: undefined, ori: 0,
    languageStyle: 'LTR',
  ...
  text_6 = new visual.TextStim({
    ...
    font: 'Arial',
    units: 'height', 
    pos: [0, 0], draggable: false, height: 0.06,  wrapWidth: undefined, ori: 0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: 1,
    depth: 0.0 
  });
  ...
  nonr_mainClock = new util.Clock();
  nonr_main = new visual.MovieStim({
    win: psychoJS.window,
    movie: 'html/resources/nonr_main.mp4',
    name: 'nonr_main',
    units: 'height',
    pos: [0, 0],
    anchor: 'center',
...
var startuemMaxDurationReached;
var _key_start_allKeys;
var startuemMaxDuration;
var startuemComponents;
function startuemRoutineBegin(snapshot) {
  return async function () {
    ...
    startuemComponents.forEach( function(thisComponent) {
...
function startuemRoutineEachFrame() {
  return async function () {
    ...
    if (text_start.status === PsychoJS.Status.STARTED) {
    }
...
function expertise_loopLoopBegin(expertise_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    expertise_loop.forEach(function() {
...
function retention_loopLoopBegin(retention_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    retention_loop.forEach(function() {
...
var expertise_questionMaxDurationReached;
var _key_respexpert_allKeys;
var expertise_questionMaxDuration;
var expertise_questionComponents;
function expertise_questionRoutineBegin(snapshot) {
  return async function () {
    ...
    expertise_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function expertise_questionRoutineEachFrame() {
  return async function () {
    ...
    // if expertise_answer is active this frame...
    if (expertise_answer.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if key_respexpert is active this frame...
...
var instr_aospanMaxDurationReached;
var _key_resp_5_allKeys;
var instr_aospanMaxDuration;
var instr_aospanComponents;
function instr_aospanRoutineBegin(snapshot) {
  return async function () {
    ...
    instr_aospanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
var warningeMaxDurationReached;
var warningeMaxDuration;
...
function warningeRoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (warningeMaxDurationReached) {
...
function memRoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (memMaxDurationReached) {
...
var warning1MaxDurationReached;
var warning1MaxDuration;
...
function warning1RoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (warning1MaxDurationReached) {
...
var video_instructionMaxDurationReached;
var _vdeonstranw_allKeys;
var video_instructionMaxDuration;
var video_instructionComponents;
function video_instructionRoutineBegin(snapshot) {
  return async function () {
    ...
    video_instructionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function video_instructionRoutineEachFrame() {
  return async function () {
    ...
    // if text_instrvideo is active this frame...
    if (text_instrvideo.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if vdeonstranw is active this frame...
...
var videooMaxDurationReached;
var videooMaxDuration;
var videooComponents;
function videooRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of which components have finished
    videooComponents = [];
    videooComponents.push(nonr_main);
    
    videooComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function videooRoutineEachFrame() {
  return async function () {
    ...
    // *nonr_main* updates
    if (t >= 0.0 && nonr_main.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      nonr_main.tStart = t;  // (not accounting for frame time here)
      nonr_main.frameNStart = frameN;  // exact frame index
      
      nonr_main.setAutoDraw(true);
      nonr_main.play();
    }
    
    if (nonr_main.status === PsychoJS.Status.FINISHED) {  // force-end the Routine
        continueRoutine = false;
    }
    // check for quit (typically the Esc key)
    if (psychoJS.experiment.experimentEnded || psychoJS.eventManager.getKeys({keyList:['escape']}).length > 0) {
...
function videooRoutineEnd(snapshot) {
  return async function () {
    ...
    nonr_main.stop();  // ensure movie has stopped at end of Routine
...
var load_instrMaxDurationReached;
var _key_resploaad_allKeys;
var load_instrMaxDuration;
var load_instrComponents;
function load_instrRoutineBegin(snapshot) {
  return async function () {
    ...
    load_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function load_instrRoutineEachFrame() {
  return async function () {
    ...
    // if load_txt is active this frame...
    if (load_txt.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if key_resploaad is active this frame...
...
var load_umMaxDurationReached;
var load_umMaxDuration;
var load_umComponents;
function load_umRoutineBegin(snapshot) {
  return async function () {
    ...
    load_umComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function load_umRoutineEachFrame() {
  return async function () {
    ...
    // if text_umm is active this frame...
    if (text_umm.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if paas is active this frame...
    if (paas.status === PsychoJS.Status.STARTED) {
    }
...
var load_fsMaxDurationReached;
var load_fsMaxDuration;
var load_fsComponents;
function load_fsRoutineBegin(snapshot) {
  return async function () {
    ...
    load_fsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function load_fsRoutineEachFrame() {
  return async function () {
    ...
    // if text_umm_2 is active this frame...
    if (text_umm_2.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if umstvennaya_2 is active this frame...
    if (umstvennaya_2.status === PsychoJS.Status.STARTED) {
    }
...
function testinstrRoutineEachFrame() {
  return async function () {
    ...
    // if text_que is active this frame...
    if (text_que.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if key_respque is active this frame...
...
var test_ratingMaxDurationReached;
var _key_resptestt_allKeys;
var test_ratingMaxDuration;
var test_ratingComponents;
function test_ratingRoutineBegin(snapshot) {
  return async function () {
    ...
    test_ratingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test_ratingRoutineEachFrame() {
  return async function () {
    ...
    // if ret_question_text is active this frame...
    if (ret_question_text.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if ret_answer is active this frame...
    if (ret_answer.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if key_resptestt is active this frame...
...
var ebatspsMaxDurationReached;
var ebatspsMaxDuration;
var ebatspsComponents;
function ebatspsRoutineBegin(snapshot) {
  return async function () {
    ...
    ebatspsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ebatspsRoutineEachFrame() {
  return async function () {
    ...
    // if text_sps is active this frame...
    if (text_sps.status === PsychoJS.Status.STARTED) {
    }
    
    frameRemains = 0.0 + 2.0 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
    if (text_sps.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      // keep track of stop time/frame for later
      text_sps.tStop = t;  // not accounting for scr refresh
      text_sps.frameNStop = frameN;  // exact frame index
      // update status
      text_sps.status = PsychoJS.Status.FINISHED;
...
function ebatspsRoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (ebatspsMaxDurationReached) {
